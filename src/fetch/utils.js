...
const methodsWithBodyAllowed = ['POST', 'PUT', 'PATCH']
...
export const isValidBody = (body) => {
  return typeof body === 'string' || isURLSearchParams(body) || isFormData(body) || isBlob(body)
}

export const getFullUrl = ({url, fullUrl}) => {
  let _url = 'http://193.124.114.46:3001/' + url
